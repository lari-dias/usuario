    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/usuario/login", "/usuario").permitAll() // Permite acesso ao endpoint de login e criação de usuário sem autenticação
    ...
    public WebMvcConfigurer corsConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/**").allowedOrigins("http://localhost:8081"); // Substitua o endereço pelo seu frontend, caso necessário
            }
        };
    }
}